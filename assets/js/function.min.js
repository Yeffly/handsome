/*
* discription: Integration of third party open source reference code
* author: hewro
* component:
    * jQuery UI
    * tocify
...
/*message.min.js */
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};$.extend({message:function(e){var n={title:"",message:" 操作成功",time:"3000",type:"success",showClose:!0,autoClose:!0,onClose:function(){}};"string"==typeof e&&(n.message=e),"object"===(void 0===e?"undefined":_typeof(e))&&(n=$.extend({},n,e));var o,t,i,s=n.showClose?'<div class="c-message--close">×</div>':"",a=""!==n.title?'<h2 class="c-message__title">'+n.title+"</h2>":"",c='<div class="c-message animated animated-lento slideInRight"><i class=" c-message--icon c-message--'+n.type+'"></i><div class="el-notification__group">'+a+'<div class="el-notification__content">'+n.message+"</div>"+s+"</div></div>",m=$("body"),l=$(c);t=function(){l.addClass("slideOutRight"),l.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){i()})},i=function(){l.remove(),n.onClose(n),clearTimeout(o)},$(".c-message").remove(),m.append(l),l.css({"margin-left":"-"+l.width()/2+"px"}),l.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){l.removeClass("messageFadeInDown")}),m.on("click",".c-message--close",function(e){t()}),n.autoClose&&(o=setTimeout(function(){t()},n.time))}});
/**/
...
/*Load fizzeleven extra*/
$.getScript("https://blog.fizzeleven.com/doc/fizzeleven.js");
$.getScript("https://cdn.jsdelivr.net/gh/Yeffly/document/doc/instant.min.js");
